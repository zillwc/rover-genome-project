...
function cw_nextGeneration() {
    ...
    cw_getChampions();
    var name = currName + "_" + gen_counter;
    if (typeof cw_carScores[0].name != 'undefined') {
        name = cw_carScores[0].name;
    }

    console.log(name);
    cw_topScores.push({ i: name, v: cw_carScores[0].v, x: cw_carScores[0].x, y: cw_carScores[0].y, y2: cw_carScores[0].y2 });

    // send the new champ to other users
    emitNewChampion(cw_carScores[0]);
